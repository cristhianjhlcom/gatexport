    ...
    <div class="flex items-start justify-between gap-10">
      ...
      <div class="flex-1 space-y-8">
        ...
        <div class="flex items-end justify-between gap-2">
          ...
          <a class="group-hover:bg-primary-400 rounded-4xl flex flex-1 items-center justify-center gap-4 bg-gray-200 px-4 py-2 text-center font-extrabold text-gray-500 group-hover:text-white"
            data-button href="{{ $product->showUrl }}">
  ...
  @if ($product)
    <article
      ...
      <div class="space-y-2 p-4 text-center">
        ...
        <a class="bg-primary-500 rounded-4xl hidden items-center justify-center gap-4 px-4 py-2 text-center text-white group-hover:flex" data-button
