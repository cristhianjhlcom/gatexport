<flux:card class="space-y-6">
    ...
    <form wire:submit="login" class="space-y-6">
        <flux:input :label="__('Email')" wire:model="form.email" autofocus autocomplete="username" required
        ...
        <flux:field>
            ...
            <flux:input wire:model="form.password" required autocomplete="current-password" type="password"
