        ...
        <div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
          <flux:field>
            ...
            <flux:input.group>
              ...
              <flux:input id="slug" placeholder="lorem-ipsum" size="sm" wire:model.blur='form.slug' />
            </flux:input.group>
          ...
          <flux:field>
            ...
            <flux:input.group>
              <flux:input.group.prefix>/</flux:input.group.prefix>
              <flux:input id="slug_en" placeholder="lorem-ipsum" size="sm" wire:model.blur='form.slug_en' />
            </flux:input.group>
